<?php
  ...
  if ($_POST['oper'] == 0){
    ...
    // 若是「請選擇」、什麼都沒選 => 將所有列出
		if ($dept == ""){
			$sql = "SELECT empl_chn_name,h.POCARD,substr(pc.CODE_CHN_ITEM,1,2)  code_chn_item,h.POVDATEB, h.POVDATEE,h.POVHOURS,h.POVTIMEB,h.POVTIMEE,h.POVDAYS,h.ABROAD, h.AGENTNO,h.serialno,h.CURENTSTATUS,h.poremark,h.depart
