<?php
  ...
  if ($_POST['oper'] == 0){
    ...
    $department_2 = substr($_POST['dept'],0,2);
    if (strlen($department_2)==2) $sql_cond = " and    substr(crjb_depart,1,2)='$department_2' "	;
    $sql ="SELECT   dept_short_name depart,empl_chn_name,f.email,over_date,do_time_1,
                   do_time_2,nouse_time,draw_date,o.empl_no
			      ...
			      AND    substr(over_date,4,2)=lpad($month,2,0)
			      AND    person_check='1' $sql_cond
			      ORDER BY over_date";
