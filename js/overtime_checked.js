...
$( // 表示網頁完成後才會載入
    function() {
        ...
        $.ajax({
            url: 'ajax/overtime_checked_ajax.php',
            data: {
        ...
        $('#qry_year').change(
            function(e) {
                if ($(':selected', this).val() !== '' && $('#qry_month').val() != null){
                    CRUD(0);
                }
            }
        )
        ...
        $('#qry_month').change(
            function(e) {
                if ($(':selected', this).val() !== '' && $('#qry_year').val() != null){
                    CRUD(0);
                }
            }
        )
        ...
        $('#qry_dept').change(
            function(e) {
                // 但是必須有選取年份
                if ($(':selected', this).val() != null && $('#qry_year').val() != null && $('#qry_month').val() != null){
                    CRUD(0);
                }
            }
        )
