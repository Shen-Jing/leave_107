    ...
    <div class="container-fluid">
        <? include ("inc/page-header.php"); ?>
            <div id="message" style="display: none;">
                <!-- 特休之類的訊息 -->
                <div class="alert alert-info"> <i class="fa fa-info" style="float:left"></i>
                    <ul> </ul>
                </div>
            </div>
                    ...
                    <form name="holidayform" id="holidayform" class="form-inline" action="holiday_form_ajax.php">
                        <table class="table table-condensed table-hover table-bordered">
                            <tr>
                                ...
                                <td class="col-sm-4"><span id="empl_name"><?=$empl_name ?></span></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="col-sm-4">
                                    <div class="form-group">
                                        <select name="vtype" id="qry_vtype" class="form-control"> </select>
                                    </div>
                                </td>
                                <td class="td1 col-sm-2">職務代理人</td>
                                <td class="col-sm-4">
                                    <div class="form-group">
                                        <!-- 根據目前的empl_no找出所屬部門的所有代理人與其代理人號碼 -->
                                        <select name="agentno" id="qry_agentno" class="form-control"> </select>
                                    </div>
                                </td>
                            </tr>
                            <tr id="agent_depart">
                                <td class="td1 col-sm-2"><span style="color: red;">請選職務代理人單位</span></td>
                                <td class="col-sm-10" colspan="3">
                                    <div class="form-group">
                                        <select name="agent_depart" id="qry_agent_depart" class="form-control"> </select>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td <? if($ismobile) echo "colspan='4'"; ?>> 
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <select name="btime" id="btime" class="form-control"></select>時
										</div>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr id="permit-row" style="display: none;">
                                <td class='td1 col-sm-2'><span style="color: red;">文號或簽呈日期</span></td>
                                <td class="col-sm-4">
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="permit" value="" maxlength="50">
									</div>
                                </td>
                            ...
                            <tr>
                                <td class="td1 col-sm-2"><span style="color: red;">是否有課</span></td>
                                <td class="col-sm-4">
                                    <input type='radio' name='haveclass' value='1'>是
                                    <input type='radio' name='haveclass' value='0' checked>否
								</td>
                                <td class="td1 col-sm-2"><span style="color: red;">是否出國</span></td>
                                <td class="col-sm-4">
                            ...
                            <tr id="nouse" style="display: none;">
                                ...
                                <td class="col-sm-10" colspan="3"> <span id="qry_nouse"></span><br />
                            ...
                            <tr id="budget" style="display: none;">
                                <td class="td1 col-sm-2"><span style="color: red;">經費來源</td>
								<td class="col-sm-10" colspan="3">
									<div class="form-group">
							...
							<tr class="bus-trip">
								<td class="td1 col-sm-2">
                                        <span style="color:blue">出差原因類型</span>
								</td>
                                <td class="col-sm-10" colspan="3">
                                    <div class="form-group">
                                        <select name='extracase' id="qry_extracase" class="form-control"> </select>
                                    </div>
                                </td>
                            </tr>
                            <tr class="bus-trip">
                                <td class="td1 col-sm-2"> <span style="color:blue">出差服務單位</span> </td>
                                <td class="col-sm-10" colspan="3">
                                    <div class="form-group">
                            ...
                            <tr class="bus-trip">
                                <td class="td1 col-sm-2"> <span style="color:blue">出差擔任職務</span> </td>
                                <td class="col-sm-10" colspan="3">
                                    <div class="form-group">
                            ...
                            <tr class="bus-trip">
                                <td class="td1 col-sm-2"> <span style="color:blue">事由或服務項目</span> </td>
                                <td class="col-sm-10" colspan="3">
                                    <div class="form-group">
                            ...
                            <tr id="bus-trip-time" style="display: none;">
                                <td class="td1 col-sm-2"> <span style="color:blue">起訖時間</span> </td>
                                <td colspan="3">
                                    <div class="col-sm-5">
                                        <div class="form-group">
                            ...
                            <tr id="depart-immig" style="display: none;">
                                <td class="td1 col-sm-2"> <span style="color: red">出國出入境時間</span> </td>
                                <td colspan="3">
                                    <div class="col-sm-5">
                                        <div class="form-group">
                            ...
                            <tr id="meeting-date" style="display: none;">
                                <td class="td1 col-sm-2"> <span style="color: red">出國會議(研究)日程</span> </td>
                                <td colspan="3">
                                    <div class="col-sm-5">
                                        <div class="form-group">
                            ...
                            <tr id="remark">
                                <td class="td1 col-sm-2">備註</td>
                                <td class="col-sm-10" colspan="3">
                                    <div class="form-group">
                                        <input type="text" class="form-control" size="50" name="remark" value="" maxlength="50" placeholder="限50個中文字"> </div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="col-sm-12" colspan="4">
                                    <div class="alert alert-warning"> <i class="fa fa-warning" style="float:left"></i>
                                        <ul>
                                            <li> 差假注意事項
                                                <ol>
                                                    <li>參加<span style="color: red;">國內訓練或講習性質</span>之各項<span style="color: red;">研習會</span>、 <span style="color: red;">座談會</span>、<span style="color: red;">研討會</span>、 <span style="color: red;">檢討會</span>、<span style="color: red;">觀摩會</span>、 <span style="color: red;">說明會</span>等，假別種類請點選<span style="color: red;">公假（受訓或研習）</span>。
                                                        <li>出差期間及行程，應視事實之需要，儘量利用便捷之交通工具縮短行程。往返行程，以不超過一日為原則。
                                                            <li>監試等任務之「公假」，假別種類請點選「公假（監考、試務等工作）」。 </ol>
                                                </li>
                                        </ul>
                                    </div>
                                </td>
